...
string HttpHandler::handleHttpRequest(string method, string path) {
  ...
  if (method == "POST") {
    if (path == "/upgrade") {
      auto url = "https://github.com/wouterdevinck/lamp/releases/download/0.5.0/lamp.bin"; // TODO get from form
  ...
  return "<!DOCTYPE html>"
    ...
    "    <input type=\"text\" name=\"url\" value=\"https://github.com/wouterdevinck/lamp/releases/download/0.5.0/lamp.bin\" size=\"60\"><br />\n"
